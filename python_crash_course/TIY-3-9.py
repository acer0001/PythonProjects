...
print(f"{guests[0].title()}, thanks for your RSVP for dinner!")
print(f"{guests[1].title()}, thanks for your RSVP for dinner!")
print(f"{guests[2].title()}, thanks for your RSVP for dinner!")
...
print(f"{guests[0].title()}, thanks for your RSVP for dinner!")
print(f"{guests[3].title()}, thanks for your RSVP for dinner!")
print(f"{guests[5].title()}, thanks for your RSVP for dinner!")
...
print(f"Maybe next time {guests_last.title()}...")
guests_last = guests.pop()
print(f"Maybe next time {guests_last.title()}...")
guests_last = guests.pop()
print(f"Maybe next time {guests_last.title()}...")
